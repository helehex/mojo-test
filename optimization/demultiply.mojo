...
fn main():
    ...
    fn auto[dt: DType, m: Int]():
        for i in range(loops):
            var o: Auto[dt, m] = Auto[dt, m](r1,r2) + Auto[dt, m](r3,r4)
            benchmark.keep(o)

    @parameter
    fn auto_[dt: DType, m: Int]():
        for i in range(loops):
            var o: Auto_[dt, m] = Auto_[dt, m](r1,r2) + Auto_[dt, m](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_neg[dt: DType]():
        for i in range(loops):
            var o: ManualNeg[dt] = ManualNeg[dt](r1,r2) + ManualNeg[dt](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_zero[dt: DType]():
        for i in range(loops):
            var o: ManualZero[dt] = ManualZero[dt](r1,r2) + ManualZero[dt](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_one[dt: DType]():
        for i in range(loops):
            var o: ManualOne[dt] = ManualOne[dt](r1,r2) + ManualOne[dt](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_one_[dt: DType]():
        for i in range(loops):
            var o: ManualOne_[dt] = ManualOne_[dt](r1,r2) + ManualOne_[dt](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_two[dt: DType]():
        for i in range(loops):
            var o: ManualTwo[dt] = ManualTwo[dt](r1,r2) + ManualTwo[dt](r3,r4)
            benchmark.keep(o)

    @parameter
    fn manual_two_[dt: DType]():
        for i in range(loops):
            var o: ManualTwo_[dt] = ManualTwo_[dt](r1,r2) + ManualTwo_[dt](r3,r4)
            benchmark.keep(o)
